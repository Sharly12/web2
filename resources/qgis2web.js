...
map.getView().fit([8975848.540123, 876556.601366, 8979797.332199, 881089.915534], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Dambulla Zonal Regulation </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (302 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Dambulla has been identified as a thriving town, leading to the implementation of development regulations for designated zones. These regulations specify permitted and prohibited activities, as well as the allowable extent of developable land, to preserve the area\'s character and prevent overcrowding.';
            }
